	...
	<ul class="slides">
		...
		<li>
			...
			<div class="caption left-align">
				<h3>ORC</h3>
				<h5>Výroba tepla a elektrické energie prostřednictví<br />organického Rankinova cyklu.</h5>
				<?= Html::a('<i class="material-icons right">keyboard_arrow_right</i>více informací', '#!', [
					'class' => 'waves-effect waves-light btn'
				]); ?>
			</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col s12 m4">
				...
				<address>
					<i class="material-icons left">person</i> <strong>Robert Vít</strong><br />
					<i class="material-icons left">phone_android</i> +420 111 222 333<br />
					<i class="material-icons left">email</i> vit@chpe.cz
				</address>
				<address>
					<i class="material-icons left">person</i> <strong>Igor Bukový</strong><br />
